...
FOREAPI=$(curl -s "https://api.openweathermap.org/data/2.5/forecast?lat={Enter lat!}&lon={Enter lon!}&appid={Enter API!}&units=imperial")
WAPI=$(curl -s "https://api.openweathermap.org/data/2.5/weather?lat={Enter lat!}&lon={Enter lon!}&appid={Enter API!}&units=imperial")
